...
from openapi_client.models.put_mobile_device_prestage import PutMobileDevicePrestage  # noqa: E501
...
class TestPutMobileDevicePrestage(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.put_mobile_device_prestage.PutMobileDevicePrestage()  # noqa: E501
        if include_optional :
            return PutMobileDevicePrestage(
                ...
                language = 'en', 
                region = 'US', 
                names = openapi_client.models.mobile_device_prestage_names.MobileDevicePrestageNames(
                    assign_names_using = 'List of Names', 
                    prestage_device_names = [
                        openapi_client.models.mobile_device_prestage_name.MobileDevicePrestageName(
                            id = 1, 
                            device_name = 'iPad', 
                            is_used = False, )
                        ], 
