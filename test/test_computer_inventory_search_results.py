...
import jamf
from jamf.models.computer_inventory_search_results import ComputerInventorySearchResults  # noqa: E501
...
class TestComputerInventorySearchResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = jamf.models.computer_inventory_search_results.ComputerInventorySearchResults()  # noqa: E501
        if include_optional :
            return ComputerInventorySearchResults(
                total_count = 3, 
                results = [
                    jamf.models.computer_inventory_response.ComputerInventoryResponse(
                        id = '1', 
                        udid = '123', 
